...
module.exports = function (dep, name, baseUrl) {
  ...
  var mightBeNodePackage = _.any(dep.pkgMeta.moduleType || [], function(moduleType){ return moduleType == "node"; });
  var canSupportAmd = _.any(dep.pkgMeta.moduleType || [], function(moduleType) { return moduleType == "amd" });
  if(mightBeNodePackage && !canSupportAmd) {
